...
#ifndef CTD_INTERFACES__SRV__DETAIL__SET_ACQUISITION__FUNCTIONS_H_
#define CTD_INTERFACES__SRV__DETAIL__SET_ACQUISITION__FUNCTIONS_H_
...
/// Initialize srv/SetAcquisition message.
/**
...
/// Finalize srv/SetAcquisition message.
/**
...
/// Create srv/SetAcquisition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ctd_interfaces__srv__SetAcquisition_Request__init().
...
/// Destroy srv/SetAcquisition message.
/**
 * It calls
 * ctd_interfaces__srv__SetAcquisition_Request__fini()
...
/// Check for srv/SetAcquisition message equality.
/**
...
/// Copy a srv/SetAcquisition message.
/**
...
/// Initialize array of srv/SetAcquisition messages.
/**
...
/// Finalize array of srv/SetAcquisition messages.
/**
 * It calls
 * ctd_interfaces__srv__SetAcquisition_Request__fini()
...
/// Create array of srv/SetAcquisition messages.
/**
 * It allocates the memory for the array and calls
 * ctd_interfaces__srv__SetAcquisition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetAcquisition messages.
/**
 * It calls
 * ctd_interfaces__srv__SetAcquisition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetAcquisition message array equality.
/**
...
/// Copy an array of srv/SetAcquisition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ctd_interfaces__srv__SetAcquisition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ctd_interfaces
...
/**
 * It calls
 * ctd_interfaces__srv__SetAcquisition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ctd_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ctd_interfaces__srv__SetAcquisition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ctd_interfaces
...
/**
 * It calls
 * ctd_interfaces__srv__SetAcquisition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CTD_INTERFACES__SRV__DETAIL__SET_ACQUISITION__FUNCTIONS_H_
