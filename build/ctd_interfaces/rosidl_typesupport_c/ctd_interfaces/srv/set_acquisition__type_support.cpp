...
static const _SetAcquisition_Request_type_support_symbol_names_t _SetAcquisition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctd_interfaces, srv, SetAcquisition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctd_interfaces, srv, SetAcquisition_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctd_interfaces, srv, SetAcquisition_Request)() {
  return &::ctd_interfaces::srv::rosidl_typesupport_c::SetAcquisition_Request_message_type_support_handle;
}
...
static const _SetAcquisition_Response_type_support_symbol_names_t _SetAcquisition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctd_interfaces, srv, SetAcquisition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctd_interfaces, srv, SetAcquisition_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ctd_interfaces, srv, SetAcquisition_Response)() {
  return &::ctd_interfaces::srv::rosidl_typesupport_c::SetAcquisition_Response_message_type_support_handle;
}
...
static const _SetAcquisition_type_support_symbol_names_t _SetAcquisition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ctd_interfaces, srv, SetAcquisition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ctd_interfaces, srv, SetAcquisition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ctd_interfaces, srv, SetAcquisition)() {
  return &::ctd_interfaces::srv::rosidl_typesupport_c::SetAcquisition_service_type_support_handle;
}
