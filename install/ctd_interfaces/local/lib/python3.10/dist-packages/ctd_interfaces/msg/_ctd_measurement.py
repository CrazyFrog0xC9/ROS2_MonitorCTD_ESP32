...
class CtdMeasurement(metaclass=Metaclass_CtdMeasurement):
    ...
    def __init__(self, **kwargs):
        ...
        self.turbidity = kwargs.get('turbidity', float())
    ...
    def __eq__(self, other):
        ...
        if self.pressure != other.pressure:
            return False
        if self.turbidity != other.turbidity:
            return False
    ...
    def turbidity(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'turbidity' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'turbidity' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
