...
bool ctd_interfaces__msg__ctd_measurement__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ctd_interfaces.msg._ctd_measurement.CtdMeasurement", full_classname_dest, 50) == 0);
  }
  ctd_interfaces__msg__CtdMeasurement * ros_message = _ros_message;
  {  // sensor_id
  ...
  {  // turbidity
    PyObject * field = PyObject_GetAttrString(_pymsg, "turbidity");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->turbidity = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // valid
...
{
  /* NOTE(esteve): Call constructor of CtdMeasurement */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ctd_interfaces.msg._ctd_measurement");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CtdMeasurement");
  ...
  {  // turbidity
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->turbidity);
    {
      int rc = PyObject_SetAttrString(_pymessage, "turbidity", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
